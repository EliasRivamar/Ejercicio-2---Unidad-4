#Una empresa de venta de grandes equipos de aire, necesita desarrollar una aoplicacion
#que le permita el calculo de IVA sobre el precio base(SIN IVA) de cada uno de los aires que vende
#Precio Base*10.5/100 para los articulos grabados con el 10.5%
#PrecioBase*21/100 para los articulos grabados con el 21%
